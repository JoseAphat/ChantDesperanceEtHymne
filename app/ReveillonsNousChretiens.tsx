...
const ReveillonsNousChretiens: React.FC = () => {
  ...
  const handleChantPress = (chant: Chant, index: number) => {
    router.push({
      ...
      previousTitle: "Reveillons-Nous Chrétiens",
      }
    });
  };
  ...
  const handleScroll = (event: any) => {
    ...
    setShowDownArrow(offsetY < RevNC.length * 60 - 600);
  };
...
export default ReveillonsNousChretiens;
