...
const ChantDesperanceCreole: React.FC = () => {
  ...
  const handleChantPress = (chant: Chant) => {
    router.push({
      ...
      params: {
        ...
        previousTitle: "Chant D'esperance Créole",
      }
    });
  };
  ...
  const handleScroll = (event: any) => {
    ...
    setShowDownArrow(offsetY < chantsC.length * 60 - 600);
  };
  ...
  return (
    <View style={styles.container}>
      ...
      <FlatList
        ...
        renderItem={({ item }) => (
          <RenderItem item={item} onPress={handleChantPress} />
        )}
...
// N'oubliez pas d'ajouter vos styles
...
export default ChantDesperanceCreole;