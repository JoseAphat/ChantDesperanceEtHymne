...
const English: React.FC = () => {
  ...
  const handleScroll = (event: any) => {
    ...
    setShowDownArrow(offsetY < englishSongs.length * 60 - 600); // Affiche la flèche vers le bas si pas tout en bas
  };
    ...
    <View style={styles.container}>
      ...
      <FlatList
       ...
       data={
        ...
        onScroll={handleScroll} // 🔹 Ajout pour mettre à jour les flèches dynamiquement
        scrollEventThrottle={16} // 🔹 Optimisation pour éviter les mises à jour trop fréquentes
      />
