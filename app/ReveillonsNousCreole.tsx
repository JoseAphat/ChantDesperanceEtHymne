...
const ReveillonsNousCreole: React.FC = () => {
  ...
  const handleChantPress = (chant: Chant, index: number) => {
    router.push({
      ...
      previousTitle: "Reveillons-Nous Créole",
    }
    });
  };
  ...
  const handleScroll = (event: any) => {
    ...
    setShowDownArrow(offsetY < ReveNC.length * 60 - 600);
  };
...
export default ReveillonsNousCreole;
