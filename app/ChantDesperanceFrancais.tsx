...
const ChantDesperanceFrancais: React.FC = () => {
  ...
  const handleScroll = (event: any) => {
    ...
    setShowDownArrow(offsetY < chantsF.length * 60 - 600);
  };
...
const styles = StyleSheet.create({
  ...
  title: {
    fontSize: scale(15), // Taille de police ajustée avec scale
    fontWeight: "600",
    color: "#0A1E42",
  },
...
export default ChantDesperanceFrancais;
