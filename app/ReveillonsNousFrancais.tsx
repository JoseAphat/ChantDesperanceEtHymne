...
const ReveillonsNousFrancais: React.FC = () => {
  ...
  const handleChantPress = (chant: Chant, index: number) => {
    router.push({
      ...
      previousTitle: "Reveillons-Nous Français",
    }
    });
  };
  ...
  const handleScroll = (event: any) => {
    ...
    setShowDownArrow(offsetY < ReveNF.length * 60 - 600);
  };
...
export default ReveillonsNousFrancais;
